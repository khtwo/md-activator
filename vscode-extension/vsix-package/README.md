...
- `md-activator-0.1.6.vsix`: VS Code extension package. It includes the extension code, icon, metadata, and bundled MD Activator server runtime.
...
4. Choose `md-activator-0.1.6.vsix` from this folder.
...
```powershell
code --install-extension .\md-activator-0.1.6.vsix --force
```
